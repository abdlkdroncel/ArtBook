...
import com.example.artbook.databinding.RecRowBinding;
...
public class ArtAdapter extends RecyclerView.Adapter<ArtAdapter.ArtHolder> {
   ...
   public ArtHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
      RecRowBinding binding=RecRowBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false);
      return new ArtHolder(binding);
   }

   @Override
   public void onBindViewHolder(@NonNull ArtHolder holder, @SuppressLint("RecyclerView") int position) {
      holder.binding.recTextView.setText(artArrayList.get(position).name);
   ...
   public class ArtHolder extends RecyclerView.ViewHolder{
      ...
      private RecRowBinding binding;
      public ArtHolder(RecRowBinding binding) {
